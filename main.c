...
int main()
{
    ...
    double a,b;
    int n,n1; //n1 is for single variable functions
...
start1:        printf("Enter the numbers:\n");
        scanf("%lf\n%lf",&a,&b);
        printf("Enter the number corresponding to the function you want:");
        scanf("%d",&n);
        switch(n)
        {
            case 1:printf("Result is %0.3lf\n",add(a,b));
            break;
            case 2:printf("Result is %0.3lf\n",sub(a,b));
            break;
            case 3:printf("Result is %0.3lf\n",mult(a,b));
            break;
            case 4:
                    { if(b==0.00)
            ...
            case 7:
                {
                    ...
                    switch(n1)
                    {
                        ...
                        case 3:printf("Result is %0.3lf\n",cu_root(a));
                        break;
                        case 4:printf("Result is %0.3lf\n",sin(a));
                        break;
                        case 5:printf("Result is %0.3lf\n",cos(a));
                        break;
                        case 6:printf("Result is %0.3lf\n",tan(a));
                        break;
                        case 7:printf("Result is %0.3lf\n",fact(a));
                        break;
                    }
                }
        }
